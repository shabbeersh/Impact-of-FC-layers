...
class cifar10vgg:
    def __init__(self,train=True):
        ...
        if train:
            ...
            self.model.load_weights('Fe_CIFAR10_CIFAR-VGG_feature_extraction_v1.h5')
    ...
    def build_model(self):
        ...
        # model.add(BatchNormalization())
        # model.add(Dropout(0.5))
        model.add(Dense(512, kernel_regularizer=regularizers.l2(weight_decay),kernel_initializer='glorot_normal'))
        model.add(Activation('relu'))
        model.add(BatchNormalization())
        model.add(Dropout(0.5))
        model.add(Dense(100))
    ...
    def train(self,model):
        ...
        csv_log = keras.callbacks.CSVLogger(
            '/home/shabbeer/Desktop/Impact of FC/Results_1/CIFAR-100/VGG/v2/CIFAR100_512X100_v2.csv',
            append=True, separator=';')
        model.save('Feature_Extraction_CIFAR100_CIFAR-VGG_feature_extraction_v2.h5')

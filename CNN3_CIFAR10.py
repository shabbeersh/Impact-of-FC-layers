...
class cifar10vgg:
    ...
    def train(self,model):
        ...
        csv_log = keras.callbacks.CSVLogger(
            '/home/shabbeer/Desktop/Impact of FC/Results_1/CIFAR-10/VGG/v2/CIFAR10_512X100_v2.csv',
            append=True, separator=';')
        model.save('Feature_Extraction_CIFAR10_CIFAR-VGG_feature_extraction_v2.h5')
